...
jQuery(function($) {
  ...
  $.extend( true, $.fn.dataTable.defaults, {
    dom:
      "<'row'<'col-12 col-sm-6'l><'col-12 col-sm-6 text-right table-tools-col0'f>>" +
      "<'row'<'col-12'tr>>" +
  ...
  $('.table-tools-col0' )//specified above in $.fn.dataTable.defaults
  .append( $_table.buttons().container() )
  //move searchbox into table header
  .find('.dataTables_filter').appendTo('.page-tools3').find('input').addClass('pl-4 radius-round')
