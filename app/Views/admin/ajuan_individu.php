    ...
    <div class="row px-2 bgc-white">
        <div class="col-md-12 mt-4 mt-md-0">
            <ul class="nav nav-tabs nav-tabs-simple nav-tabs-scroll border-b-1 brc-secondary-l2 mx-n3 mx-md-0 px-3 px-md-0" role="tablist">
                <li class="nav-item">
                    <a class="nav-link brc-warning-tp2 d-style active btn_baru" id="home-tab" data-toggle="tab" href="#home0" role="tab" aria-controls="home" aria-selected="true" onclick="tabel_baru('baru')">
                ...
                <li class="nav-item">
                    <a class="nav-link brc-purple-tp2 d-style" id="profile-tab" data-toggle="tab" href="#profile0" role="tab" aria-controls="profile" aria-selected="false" onclick="tabel_proses('proses')">
                ...
                <li class="nav-item">
                    <a class="nav-link brc-purple-tp2 d-style" id="rutin-tab" data-toggle="tab" href="#rutin0" role="tab" aria-controls="rutin" aria-selected="false" onclick="tabel_rutin('rutin')">
                ...
                <li class="nav-item">
                    <a class="nav-link brc-success-tp2 d-style" id="contact-tab" data-toggle="tab" href="#contact0" role="tab" aria-controls="contact" aria-selected="false" onclick="tabel_selesai('selesai')">
                        <i class="fa fa-check-square text-success-m2 mr-3px"></i>
                        <span class="d-n-active">Selesai (Disetujui)</span>
                        <span class="d-active text-success">Selesai (Disetujui)</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link brc-danger-tp2 d-style" id="ditolak-tab" data-toggle="tab" href="#ditolak0" role="tab" aria-controls="ditolak" aria-selected="false" onclick="tabel_ditolak('ditolak')">
