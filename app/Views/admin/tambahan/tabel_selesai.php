            ...
            <table id="datatable" class="table table-border-y text-dark-m2 text-95 border-y-1 brc-secondary-l1">
                <thead class="text-secondary-m2 text-uppercase text-85">
                    <tr>
                        ...
                        <th class="border-0 bgc-h-default-l3">Tersalurkan</th>
                ...
                <tbody>
                    ...
                    foreach ($ajuan_baru as $ajuan) : ?>
                        <tr class="d-style bgc-h-default-l4">
                            ...
                            <?php
                            if ($ajuan['status_tersalurkan'] == 'belum') {
                                $badge = 'badge-danger';
                                $text_tslr = 'belum';
                            } elseif ($ajuan['status_tersalurkan'] == 'tersalurkan sebagaian') {
                                $badge = 'badge-warning';
                                $text_tslr = 'sebagian';
                            } elseif ($ajuan['status_tersalurkan'] == 'tersalurkan semua') {
                                $badge = 'badge-success';
                                $text_tslr = 'semua';
                            } else {
                            ...
                            ?>
                            <td>
                                <span class="badge badge <?= $badge; ?> arrowed-in radius-0" class="text-105"><?= $text_tslr; ?></span>
                            </td>
                            <td>
