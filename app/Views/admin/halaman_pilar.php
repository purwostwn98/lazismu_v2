                    ...
                    <table id="datatable" class="table table-border-y text-dark-m2 text-95 border-y-1 brc-secondary-l1">
                        <thead class="text-secondary-m2 text-uppercase text-85">
                            <tr>
                                ...
                                <th class="border-0 bgc-h-default-l3">Nama Pilar</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($data_pilar as $pilar) : ?>
                                <tr class="d-style bgc-h-default-l4">
                                    <td>
                                        <span class="text-105"><?= $no++; ?></span>
                                    </td>
                                    <td>
                                        <span class="text-105"><?= $pilar['nama_pilar']; ?></span>
                                    </td>
                                    <td class="text-grey">
                                        <a data-rel="tooltip" title="Lihat Detail" href="/admin/halaman_kategori/<?= $pilar['id_pilar']; ?>"><i class="fa fa-eye text-blue-m1 text-120"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
